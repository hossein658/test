...
/**
 * REST controller for managing {@link Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
     ...
     */
    @GetMapping("/articles")
    public ResponseEntity<List<ArticleDTO>> getAllArticles(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
