...
import { ICustomerAccount, CustomerAccount, Status, AccountType } from 'app/shared/model/customer-account.model';
...
describe('Service Tests', () => {
  describe('CustomerAccount Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new CustomerAccount(0, 'AAAAAAA', Status.ACTIVE, AccountType.LONG, 0);
    });
